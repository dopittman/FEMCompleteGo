...
// helps decouple the database since the application layer will only interact with the WorkoutStore
...
func (pg *PostgresWorkoutStore) CreateWorkout(workout *Workout) (*Workout, error) {
	...
	defer tx.Rollback() // rollback the transaction to the state before the call
